...
import './Astro404.scss';

function App({ titulo, msg }) {
  ...
  return (
    <>
      <div ref={container} className="bg"></div>
      <div className="texto">{titulo}</div>
      <div className="texto">{msg}</div>
        ...
        <div className="body-top">
          ...
          <div className="panza">
            <div className="screen">
              <svg className="girar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 841.9 595.3">
                <g fill="#333">
